...
import com.example.thuchanh3.service.CustomerService;
import com.example.thuchanh3.service.ICustomerService;
...
public class CustomerController {
    ...
    public String edit(@PathVariable int id, Model model) {
        model.addAttribute("customer", customer.findById(id));
        return "/edit";
    }
    @PostMapping("/update")
